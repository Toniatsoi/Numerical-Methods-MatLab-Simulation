function leonard
    equation_str = input('Enter your desired equation to calculate(in terms of x): ', 's');
    ...
    while true
        ...
        % Check if the sign of f(xL) changed
        if f_xL * f_xL_prev < 0
            break;
        end
    ...
    elseif method_choice == 2
        ...
        delta_x_incremental = input('Enter delta x : ');
    ...
    elseif method_choice == 3
        ...
        xl_bisection = input('Enter the lower bound: ');
        xu_bisection = input('Enter the upper bound: ');
